...
// Laba_prog.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLabaprogApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLabaprogApp

CLabaprogApp::CLabaprogApp()
{
...
// Единственный объект CLabaprogApp

CLabaprogApp theApp;


// Инициализация CLabaprogApp

BOOL CLabaprogApp::InitInstance()
{
